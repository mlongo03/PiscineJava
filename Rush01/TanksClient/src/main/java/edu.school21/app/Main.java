...
public class Main extends Application {
    ...
    private Parent createContent() {
        ...
        Label l1 = new Label("SERVER URL");
        Label l2 = new Label("SERVER PORT");
        l2.setLayoutY(25);
        Label l3 = new Label("HEALT POINTS");
        l3.setLayoutY(50);
                    ...
                    try {
                        ...
                        switch (split[0]) {
                            ...
                            case "H\n":
                                ...
                                // da gestire game over
                                break;
                            case "W\n":
                                dos.writeUTF("R:" + shoots + ":" + hits + ":" + misses + "\n");
                                // da gestire fine gioco
